...
def send_request_to_google_analytics(utm_url, environ):
  ...
  // communicating with Google Analytics are thown.    
    ...
    req.add_header("User-Agent", environ.get('HTTP_USER_AGENT', 'Unknown'))
    req.add_header("Accepts-Language:", environ.get("HTTP_ACCEPT_LANGUAGE",''))
...
#            pass
        import logging
        logging.error("gamobile failed: %s" % utm_url)
        pass
